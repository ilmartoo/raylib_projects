...
typedef enum SpaceshipType { SPACESHIP_FRIENDLY_BASE = 0, SPACESHIP_FRIENDLY_UPGRADED, SPACESHIP_ENEMY_BASE, SPACESHIP_ENEMY_UPGRADED } SpaceshipType;
...
#define PROJECTILE_BASIC_BOUNDING_CIRCLE(rotation) \
    BOUNDING_CIRCLE_DEFINITION(0, PROJECTILE_BASIC_SIZE_X - (PROJECTILE_BASIC_SIZE_Y * 0.5f), PROJECTILE_BASIC_SIZE_X, rotation + PROJECTILE_DRAW_ROTATION)
...
Projectile* ProjectileCreate(
    ProjectileType type, Vector2 position, Vector2 size, f32 projectile_speed, f32 rotation, BoundingCircle bounding_circle, u32 damage, u32 range);
...
#define PLAYER_ABILITY_SHOOT               ABILITY_PROJECTILE_DEFINITION(PLAYER_ABILITY_SHOOT_DAMAGE, PLAYER_ABILITY_SHOOT_RANGE, PLAYER_ABILITY_SHOOT_COOLDOWN_TIME)
...
#define PLAYER_ABILITY_MISSILE               ABILITY_PROJECTILE_DEFINITION(PLAYER_ABILITY_MISSILE_DAMAGE, PLAYER_ABILITY_MISSILE_RANGE, PLAYER_ABILITY_MISSILE_COOLDOWN_TIME)
...
#define ENEMY_BOUNDING_CIRCLE(rotation) BOUNDING_CIRCLE_DEFINITION(0, 2, (ENEMY_DIAMETER * 0.5f) + ENEMY_BOUNDING_CIRCLE_EXTRA, rotation + ENEMY_DRAW_ROTATION)
...
#define ENEMY_ABILITY_SHOOT               ABILITY_PROJECTILE_DEFINITION(ENEMY_ABILITY_SHOOT_DAMAGE, ENEMY_ABILITY_SHOOT_RANGE, ENEMY_ABILITY_SHOOT_COOLDOWN_TIME)

...
#define __ILMARTO_TEST_PERCENT_COLOR(percent)                                                                                              \
    (percent < 50 ? __ILMARTO_TEST_FAILED_COLOR : percent < 75 ? __ILMARTO_TEST_WARN_COLOR : __ILMARTO_TEST_PASSED_COLOR)
...
#define __ILMARTO_TEST_TEST_GROUP(name, testGroupBlock)                                                                                    \
    do {                                                                                                                                   \
        ...
        printf(__ILMARTO_TEST_GROUP_RESULT "\n", total, __ILMARTO_TEST_PERCENT_COLOR(percentage), percentage, testGroup.passed);           \
    } while (0)
...
#define __ILMARTO_TEST_ASSERT_MEM_CONTENTS(msg, expected, value, mem_size)                                                                 \
    __ILMARTO_TEST_ASSERT_AND_DISPLAY(msg, 0 == memncmp((char *)expected, (char *)value, mem_size),                                        \
                                      "assert_mem_same(" #expected ", " #value ")")
#define __ILMARTO_TEST_ASSERT_MEM_ZERO(msg, value, mem_size)                                                                               \
    __ILMARTO_TEST_ASSERT_AND_DISPLAY(msg, 1 == __ILMARTO_TEST_IS_MEMORY_ZERO(value, mem_size), "assert_mem_zero(" #value ")")
#define __ILMARTO_TEST_ASSERT_SAME_STRING(msg, expected, value)                                                                            \
    __ILMARTO_TEST_ASSERT_AND_DISPLAY(msg, 0 == strcmp(expected, value), "assert_string_same(\"" #expected "\", \"" #value "\")")
#define __ILMARTO_TEST_ASSERT_DIFFERENT_STRING(msg, expected, value)                                                                       \
    __ILMARTO_TEST_ASSERT_AND_DISPLAY(msg, 0 == strcmp(expected, value), "assert_string_different(\"" #expected "\", \"" #value "\")")
